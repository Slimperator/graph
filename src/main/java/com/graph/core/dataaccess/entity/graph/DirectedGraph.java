...
public class DirectedGraph extends AbstractGraph {
    ...
    public DirectedGraph(Set<SimpleVertex> vertexes, Set<NonWeightedEdge> edges) {
    ...
    @Override
    public void addEdge(@NonNull SimpleVertex vertexFrom, @NonNull SimpleVertex vertexTo, @NonNull NonWeightedEdge edge) {
        ...
        super.getVertexes().removeAll(asList(vertexFrom, vertexTo));
